...
> From now on, all new GitLab versions that support official ARM64 images will use those images when creating our tags, ensuring compatibility and reliability. Essentially, you'll be using GitLab’s official images—just with the added flexibility of our tagging system.
> 
